...
public class AdvancedRush extends AbstractionLayerAI {
    ...
    public AdvancedRush(UnitTypeTable unitTypeTable) {
        this(unitTypeTable, new AStarPathFinding());
    }

    public AdvancedRush(UnitTypeTable unitTypeTable, PathFinding pathFinding) {
        super(pathFinding);
    ...
    @Override
    public AI clone() {
        return new AdvancedRush(unitTypeTable, pf);
    }
